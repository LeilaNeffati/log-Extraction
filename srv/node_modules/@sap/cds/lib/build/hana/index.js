...
class HanaModuleBuilder extends BuildTaskHandlerOData {
    ...
    async _compileToHdbtabledata(model, dest) { //NOSONAR
        ...
        if (csvFiles.length > 0) {
            ...
            const stripCsvComments = this.task.options.stripCsvComments !== false && this.task.options.stripCsvComments !== 'false'
            if (stripCsvComments) await this._stripCsvComments(csvFiles)
